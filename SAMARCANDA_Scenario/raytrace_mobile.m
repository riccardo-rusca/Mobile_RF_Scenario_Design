...
FINAL_FILENAME="SAMARCANDA_scenario_1GHz_duplex.mat";

%% Selected communication frequency for the scenario
COMM_FREQUENCY=1e9; % In [Hz]

%% Parse data and define area for Colosseum
filename = 'SAMARCANDA_dataset.csv';
...
%% 1 km square coordinates (Colosseum requires the vehicles to be limited in a 1 km^2 area)
...
%% For pruning timestamps we decided to use only the one from 2500 to 7700 instead of all
